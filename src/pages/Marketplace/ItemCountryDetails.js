...
import Insights from "../Governing/Insights";
...
const ItemCountryDetails = ({ details }) => {
  ...
  return (
    <Row>
      <Row gutter={[ 24, 24 ]}>
        <Col span={16}>
       <span style={{ textTransform: "uppercase" }}> <FormattedMessage id="marketplace.itemDetails.itemForSell" /></span>
          <div>
            <h1 style={{ fontWeight: "700", letterSpacing: "2px" }}>{title}</h1>{" "}
            <div>
            <FormattedMessage id="marketplace.itemDetails.ownedBy" />
            &nbsp;
        ...
        <Col span={24}>
          ...
          <Col span={24}>
            <Row>
              <Collapse bordered={false}>
                <Panel
                  header={<span style={{ color: "grey", textTransform: "uppercase" }}>            
                  <FormattedMessage id="marketplace.itemDetails.ownership" />                  </span>}
                  key="1"
                >
                ...
                <Panel
                  header={<span style={{ color: "grey", textTransform: "uppercase" }}>            
                  <FormattedMessage id="marketplace.itemDetails.insights" />
                  </span>
                  }
                  key="2"
          ...
          <Row style={{ float: "right", marginTop: "5%", width: "100%" }}>
            ...
            <a href={`/c/${countryUniqueName}`} target="_blank" rel="noopener noreferrer">
              <Button style={{ width: "48%", height: "38px" }}>            
              <FormattedMessage id="marketplace.itemDetails.view" />
</Button>
            </a>
          </Row>
        </Col>
